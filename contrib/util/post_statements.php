...
if (!getenv('OPENEMR_ENABLE_POST_STATEMENTS_API')) {
    die('Set OPENEMR_ENABLE_POST_STATEMENTS_API=1 environment variable to enable this script');
}
...
$filename = 'SUN002-NextechPatientStatements-20250922071517.csv';
