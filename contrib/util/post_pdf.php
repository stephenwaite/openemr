...
foreach ($records as $record) {
    ...
    if (stripos($photoName, 'insur') !== false) {
        $category = "billingdocuments";
    } elseif (stripos($photoName, 'demo') !== false) {
        $category = "officedocuments";
    } elseif (stripos($photoName, 'auth') !== false) {
        $category = "billingdocuments";
    } elseif (stripos($photoName, 'refer') !== false) {
        $category = "billingdocuments";
    } elseif (stripos($photoName, 'eob') !== false) {
        $category = "billingdocuments";
    } elseif (stripos($photoName, 'benefit') !== false) {
        $category = "billingdocuments";
    } elseif (stripos($photoName, 'medical history') !== false) {
