...
if (!function_exists('do_question')) {
	function do_question($question,$data='') {
		$content = "";
		if ($question)
			$content = "<tr><td class='wmtOutput' colspan='3'>".$question."</td><td class='wmtLabel' style='text-align:left;padding-left:20px;width:20%;vertical-align:top;font-size:14px;'>".$data."</td></tr>\n";
		return $content;
	}
}
