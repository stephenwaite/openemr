...
.col4 {width:12%}
//.col5 {width:30%}
.col6 {min-width:60px;text-align:right}
</style>
...
<table width='100%' cellspacing='0' cellpadding='0' border='0'>
 <tr class='head'>
  ...
  <th class='col2' align='left'><?php xl('Orderable','e') ?></th>
  <th class='col3' align='left'><?php xl('Code','e') ?></th>
  <th class='col4' align='left'><?php xl('Type','e') ?></th>
  <!-- th class='col5' align='left'><?php xl('Description','e') ?></th -->
  <th class='col6' align='left'>&nbsp;</th>
 </tr>
</table>
