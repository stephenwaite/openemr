<?php
/**
 * MIPS Quality Measure 180 - Rheumatoid Arthritis (RA): Glucocorticoid Management
 * 2025 Specifications
 * 
 * DENOMINATOR REPORT
 * This report identifies patients who meet the denominator criteria and checks for glucocorticoid management assessments.
 * 
...
while ($row = sqlFetchArray($res)) {
    ...
    // Check for glucocorticoid management assessments (rule_patient_data with item = 'act_glucocorticoid')
...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    header('Content-Disposition: attachment; filename="MIPS_180_RA_Glucocorticoid_Management_' . date('Y-m-d') . '.csv"');
    ...
    fputcsv($output, array(
        ...
        'Encounter Dates',
        'RA ICD-10 Codes',
        'Assessment Found (act_glucocorticoid)',
...
<html>
<head>
    <title>MIPS 180 Rheumatoid Arthritis Glucocorticoid Management - Denominator Report</title>
    <style>
...
<body>
    ...
    <div class="report-info">
        <p><strong>Measure:</strong> MIPS 180 - RA: Glucocorticoid Management</p>
    ...
    <div class="note">
        ...
        (two encounters at least 90 days apart, age >= 18, non-telehealth) and checks whether they have glucocorticoid management
        assessments recorded as rule item 'act_glucocorticoid' during the performance and prior periods. Assessment results are now displayed.
    </div>
    ...
    <div class="info-box">
        ...
        <ul>
            <li>This report checks for entries in <strong>rule_patient_data</strong> table with <strong>item = 'act_glucocorticoid'</strong></li>
        ...
        <ul>
            ...
            <li>Verify that glucocorticoid management assessments are being recorded with proper result values</li>
            <li>Ensure clinical staff are documenting RA glucocorticoid management</li>
