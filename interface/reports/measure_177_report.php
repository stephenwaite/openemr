 ...
 * 
 * DENOMINATOR REPORT
 * This report identifies patients who meet the denominator criteria and checks for disease activity assessments.
 * 
...
while ($row = sqlFetchArray($res)) {
    ...
    // Check for disease activity assessments (rule_patient_data with item = 'act_cdai')
...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    header('Content-Disposition: attachment; filename="MIPS_177_RA_Assessment_Report_' . date('Y-m-d') . '.csv"');
...
<html>
<head>
    <title>MIPS 177 Rheumatoid Arthritis Disease Activity Assessment - Denominator Report</title>
    <style>
...
<body>
    ...
    <div class="report-info">
        <p><strong>Measure:</strong> MIPS 177 - RA: Periodic Assessment of Disease Activity</p>
    ...
    <div class="note">
        ...
        (two encounters at least 90 days apart, age >= 18, non-telehealth) and checks whether they have disease activity
        assessments recorded as rule item 'act_cdai' during the performance and prior periods. Assessment results are now displayed.
    </div>
    ...
    <div class="info-box">
        ...
        <ul>
            <li>This report checks for entries in <strong>rule_patient_data</strong> table with <strong>item = 'act_cdai'</strong></li>
            <li>Assessments are tracked for both 2024 (prior period) and 2025 (performance period)</li>
            <li>The report now displays the <strong>result</strong> field value for each assessment along with the date</li>
            <li>Format: Date (Result: value) - for example: 2025-03-15 (Result: 12.5)</li>
        ...
        <ul>
            ...
            <li>Verify that disease activity assessments are being recorded with proper result values</li>
            <li>Ensure clinical staff are documenting RA disease activity using tools like DAS28, CDAI, RAPID3, etc.</li>
