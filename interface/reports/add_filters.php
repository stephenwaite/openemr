...
$query = "SELECT * from rule_filter where `value` like '%rheumatoid arthritis%'";
$res = sqlStatement($query);
while ($row = sqlFetchArray($res)) {
    var_dump($row);
    echo "</br>";
    foreach ($pieces as $dx) {
        //echo $dx . "</br>";
        $queery =  "INSERT INTO rule_filter SET id = '" . $row['id'] . "'" .
         ", include_flag = '1', required_flag = '0', method = 'filt_lists' " .
         ", method_detail = 'medical_problem', value = 'ICD10::" . $dx . "'";
        echo $queery . "</br>";
        /*if ($r = sqlStatement($queery)) {
            echo "success: $queery";
        } else {
            echo "uh oh";
        }*/
