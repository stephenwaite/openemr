...
function appendOptionRadioCriteria(text0,value0,text1,value1,seperator,Type)
{//If option doesn't exist new insertion is done.If exist it is updated in the select drop down.//Remove the item if the option is All.
...
function SetDateCriteriaCustom(ObjectPassed)
 {//Setting the value of drop down to 'custom' when user changes the date manually using the date picker.
