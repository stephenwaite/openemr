...
$html .= "
<style>
#csspatname {font-family:mono;  font-size: 20px; position:relative; top:100px; left:5px; display: inline-block; width:320px}
#cssdob     {font-family:mono;  font-size: 20px; position:relative; top:100px; left:15px; display: inline-block; width:125px}
#cssdos     {font-family:mono;  font-size: 14px; position:relative; top:100px;            display: inline-block; width:100px}
#cssinsname {font-family:mono;  font-size: 16px; position:relative; top:100px; left:35px; display: inline-block; width:175px}
#cssrefname {font-family:mono;  font-size: 14px; position:relative; top:100px; left:75px; display: inline-block; width:150px}
div.pagebreak {
