...
#cssdos {font-family:mono; font-size: 16px;  position:relative; top:105px;}
#csspatname {font-family:mono;  font-size: 16px; position:relative; top:105px; left:15px; display: inline-block; width:250px;}
#cssdob {font-family:mono;  font-size: 16px; position:relative; top:105px; left:15px;}
#cssinsname {font-family:mono;  font-size: 16px; position:relative; top:105px; left:75px}
#cssrefname {font-family:mono;  font-size: 16px; position:relative; top:105px; left:75px}
.ftitletable {
width: 100%;
...
<td colspan='3' valign='top' class='fshead' style='height:" . $lheight * 2 . "pt'>";
          ...
          //  $html .= ":";
            ...
            //echo $whichdate;
          //  $html .= "<br />";  
            $html .= "<span id=cssdos>" . $whichdate . "</span>" ;
  ...
  //          if ($form_fill)
   ...
   //         $html .= "<br />";  
       //     $html .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp';
            ...
            if ($form_fill)
                $html .= "<span id=cssdob>" . $patdata['DOB'] . "</span>";
