...
$html .= "
<style>
#csspatname {font-family:mono;  font-size: 20px; position:relative; top:125px; left:15px; display: inline-block; width:320px}
#cssdob     {font-family:mono;  font-size: 20px; position:relative; top:125px; left:15px; display: inline-block; width:125px}
#cssdos     {font-family:mono;  font-size: 14px; position:relative; top:125px;            display: inline-block; width:100px}
#cssinsname {font-family:mono;  font-size: 16px; position:relative; top:125px; left:35px; display: inline-block; width:175px}
#cssrefname {font-family:mono;  font-size: 14px; position:relative; top:125px; left:75px; display: inline-block; width:150px}
div.pagebreak {
...
<td colspan='3' valign='top' class='fshead' style='height:" . $lheight * 2 . "pt'>";
          ...
          //  $html .= ":";
            ...
            //echo $whichdate;
          //  $html .= "<br />";  
            $html .= "<span id=cssdos>" . steveDate($whichdate) . "</span>" ;
  ...
  //          if ($form_fill)
   ...
   //         $html .= "<br />";  
       //     $html .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp';
            ...
            if ($form_fill)
                $html .= "<span id=cssdob>" . steveDate($patdata['DOB']) . "</span>";
...
<td colspan='4' valign='top' class='fshead' style='height:${lheight}pt'>";
                ...
                if ($form_fill) {
                    foreach (array('primary') as $instype) {
                        ...
                        if ($row['provider']) {
                            ...
                            if ($instype = 'primary')
                                $html .= "<span id=cssinsname>" . $insco_name . "</span>";
                            else {
                              // $html .= "<span id=cssinsname>Unassigned</span>";
                            }
                        }
                        else  $html .= "<span id=cssinsname>Unassigned</span>";
                    }
                }
            } else {
            ...
            $html .= "<span id=cssrefname>" . $docresult['fname'] . ' ' . $docresult['lname'] . "</span>" ;
            $html .= "</td>
</tr>";
