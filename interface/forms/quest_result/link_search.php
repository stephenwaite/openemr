...
function searchme() {
 var f = document.forms[0];
 var url = 'link_select.php?id=<?php echo $form_id ?>';
...
<form action='link_search.php' name='demographics_form' method='post' onsubmit='return validate(this)'>
<input type="hidden" name="id" value="<?php echo $form_id ?>" />
<span class='title'><?php xl('Search Patient','e'); ?></span>
