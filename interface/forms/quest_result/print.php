...
include_once("{$GLOBALS['incdir']}/forms/quest_result/report.php");
...
$result_data = new wmtForm('quest_result',$id);
$order_data = new wmtForm('quest_order',$result_data->request_id);
...
<html>
	<head>
		...
		<title>Quest Lab Results for <?php echo $order_data->pat_last; ?>", " <?php echo $order_data->pat_first; ?><?php echo ($order_data->pat_middle)?" ".$order_data->pat_middle:''; ?> on <?php echo $order_data->order_date; ?></title>
...
*/ ?>
		<?php quest_result_report($pid, $encounter, '*', $id); ?>
	</body>
</html>