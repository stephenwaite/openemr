...
$category = sqlQuery("SELECT id FROM categories WHERE name LIKE ?",array('Quest Diagnostic'));
$cat_id = $category['id'];
	...
	* --------------------------------------------------------------------------- */
	...
	foreach ($message->documents as $document) {
		if ($document->documentData) {
			...
			$category = sqlQuery("SELECT id FROM categories WHERE name = ?",array('Quest Diagnostic'));
