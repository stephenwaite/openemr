...
if (sqlNumRows($result) == 0) {
	...
	$query .= "WHERE ls.`list_id` LIKE '" . $lab_data['npi'] . "\_Laboratory%' ";
								...
								<tr>
									<td class="wmtLabHeader wmtColorHeader">
										...
										<div style="float: left; vertical-align: bottom;">
											<input class="wmtButton" type="button"
												style="vertical-align: top"
												onclick="addCodes()" value="add selected" /> </div>
										<div style="float: right;margin-bottom:5px">
											<input class="wmtInput"
												style="background-color: white; vertical-align: top; margin-right:3px"
												type="text" name="searchIcd" id="searchIcd" /><input
												class="wmtButton" type="button" value="search"
												onclick="searchDiagnosis()" /> </div>
									</td>
								</tr>
								<tr>
									<td class="wmtLabBody">
									...
									<td class="wmtLabHeader wmtColorHeader">
										...
										<div style="float: right">
											<input class="wmtInput"
												...
												class="wmtButton" type="button" style='vertical-align: top'
												value="search" onclick="searchTest()" /> </div></td>
								</tr>
								<tr>
									<td class="wmtLabBody">
										<div id="oc_tabs">
...
<?php } ?>
										...
										<td style="white-space: nowrap"><input type="text"
											class="wmtInput" style="width: 50px" name='time_collected'
											id='time_collected'
...
<?php if ($lab_data['npi'] != 'QUEST' && $lab_data['recv_fac_id'] != 'QBA') { ?>
											<td style="text-align: right; min-width: 65px"><label
											class="wmtLabel">Volume: </label></td>
										<td style="white-space: nowrap"><input type="text"
											class="wmtInput" style="width: 65px" name='specimen_volume'
											id='specimen_volume'
...
<?php } // END SPECIAL FOR QBA ?>
										...
										<td style="white-space: nowrap"><select
											name='specimen_fasting' class='wmtSelect'>
									...
									<tr id="psc_data" style="<?php if (!$order_data->order_psc && !$GLOBALS['wmt_lab_psc']) echo "display:none" ?>">
										...
										<td style="width: 100%"><input class="wmtInput" type='text'
											style='width: 80px' name='date_pending' id='date_pending'
...
<?php } ?>
				<tr>
				<td class="wmtLabel"
					style="vertical-align: top; float: left; width: 80px"><a
