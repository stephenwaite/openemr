                            ...
                            <div class="form-group">
                                ...
                                <div
                                    ...
                                    if ($GLOBALS['ippf_specific']) {
                                        ...
                                        <label for='form_onset_date' class="control-label col-sm-2 oe-text-to-right"><?php echo $date_label; ?> &nbsp;<i id='onset-tooltip' class="fa fa-info-circle text-primary" aria-hidden="true"></i></label>                                    <div class="col-sm-3">
