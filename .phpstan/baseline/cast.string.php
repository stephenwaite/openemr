...
$ignoreErrors[] = [
    'message' => '#^Cannot cast mixed to string\\.$#',
    'count' => 21,
    'path' => __DIR__ . '/../../library/classes/rulesets/Cqm/reports/common/Immunizations.php',
];
$ignoreErrors[] = [
    'message' => '#^Cannot cast mixed to string\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Cannot cast mixed to string\\.$#',
    'count' => 1,
    'path' => __DIR__ . '/../../src/RestControllers/Subscriber/ViewRendererListener.php',
];
$ignoreErrors[] = [
    'message' => '#^Cannot cast mixed to string\\.$#',
    'count' => 1,
...
$ignoreErrors[] = [
    'message' => '#^Cannot cast mixed to string\\.$#',
    'count' => 3,
    'path' => __DIR__ . '/../../tests/Tests/Isolated/Billing/BillingClaimTest.php',
];
$ignoreErrors[] = [
    'message' => '#^Cannot cast mixed to string\\.$#',
    'count' => 1,
